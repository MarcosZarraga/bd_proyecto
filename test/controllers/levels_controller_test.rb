...
class LevelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post levels_url, params: { level: { name: @level.name, school_id: @level.school_id } }, as: :json
    end
  ...
  test "should update level" do
    patch level_url(@level), params: { level: { name: @level.name, school_id: @level.school_id } }, as: :json
    assert_response 200
  end
